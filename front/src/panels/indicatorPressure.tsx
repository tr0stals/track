...
const IndicatorPressure: React.FC<NumberInputFieldProps> = ({ style }) => {
  const [number, setNumber] = useState<string>('110/70'); // начальное значение числа
...
export default IndicatorPressure;
